...
class GraphState(TypedDict):
    ...
    Attributes:
        ...
        # -- Ideation Fields --
        # initial_idea: Optional[str] # Optional initial user suggestion for the scene concept.
        # generated_ideas: Optional[List[str]] # List of scene ideas generated by the ideation step.
        # selected_idea: Optional[str] # The scene idea selected by the user.
    """
